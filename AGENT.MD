...
- [Image Embedding Implementation](#image-embedding-implementation)
  - [Overview](#overview-1)
  - [Key Features](#key-features)
  - [API Requirements](#api-requirements)
  - [Implementation Standards](#implementation-standards)
  - [Testing Requirements](#testing-requirements-1)
  - [Performance Guidelines](#performance-guidelines-1)
  - [Code Quality Standards](#code-quality-standards-1)
  - [Integration Guidelines](#integration-guidelines-1)
- [Lessons from Notion Export](#lessons-from-notion-export)
  - [Image Sizing](#image-sizing)
  - [Positioning](#positioning)
  - [Critical Image Positioning Rule](#critical-image-positioning-rule)
  - [File Structure](#file-structure)
  - [Validation](#validation)
- [Test Implementation](#test-implementation)
  - [ImageEmbedGenerators.swift](#imageembedgeneratorsswift)
  - [Validation Process](#validation-process)
- [Usage Examples](#usage-examples)
  - [Basic Image Embedding](#basic-image-embedding)
  - [CSV with Image Embedding](#csv-with-image-embedding)
- [Performance Considerations](#performance-considerations-1)
  - [Memory Management](#memory-management-1)
  - [File Size Optimization](#file-size-optimization-1)
