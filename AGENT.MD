...
- [Detailed Module Breakdown](#detailed-module-breakdown)
  - [XLKitCore Module](#xlkitcore-module)
  - [XLKitFormatters Module](#xlkitformatters-module)
  - [XLKitImages Module](#xlkitimages-module)
  - [XLKitXLSX Module](#xlkitxlsx-module)
  - [XLKit Module](#xlkit-module)
- [Sheet API Reference](#sheet-api-reference)
- [Workbook API Reference](#workbook-api-reference)
- [CSV/TSV API Reference](#csvtsv-api-reference)
...
- [Architecture Update (2025-07-07)](#architecture-update-2025-07-07)
- [Compliance & Validation](#compliance--validation)
- [Developer Workflow](#developer-workflow)
- [Recent Improvements](#recent-improvements)
- [Image Embedding Implementation (2025-01-27)](#image-embedding-implementation-2025-01-27)
  - [Overview](#overview-1)
  - [Key Features](#key-features)
  - [Implementation Details](#implementation-details)
  - [Lessons Learned from Notion Export](#lessons-learned-from-notion-export)
  - [Test Implementation](#test-implementation)
  - [Usage Examples](#usage-examples)
  - [Performance Considerations](#performance-considerations-1)
  - [Future Enhancements](#future-enhancements)
- [Test Documentation](#test-documentation)
- [Image Embedding and Aspect Ratio Support](#image-embedding-and-aspect-ratio-support)

---

## Library Overview

XLKit is a modern Swift library for creating and manipulating Excel (.xlsx) files on macOS. The library is built with a modular architecture using Swift Package Manager (SPM) modules, targeting Swift 6.0 and macOS 12+.
...
**Critical Image Positioning Rule**
- **MANDATORY**: `rowOff = 0` in drawing XML to keep images within cell boundaries
- Images must be positioned exactly at cell start point with no offsets
- Any `rowOff` value other than 0 will cause Excel to stretch images beyond cell boundaries
- This rule is essential for maintaining aspect ratio - violation will cause image distortion
...
All test cases, categories, and coverage details are documented in [Tests/README.md](Tests/README.md). This file provides a comprehensive overview of the test suite, including descriptions, purposes, and validation standards for every test in XLKit.

When adding or updating tests, ensure that Tests/README.md is updated to reflect new or changed test cases. The test documentation must remain synchronized with the actual test suite for accuracy and completeness.

## Image Embedding and Aspect Ratio Support

XLKit now supports pixel-perfect image embedding with automatic aspect ratio preservation for all common and professional video/cinema formats. The following aspect ratios are tested and validated:
- 16:9 (HD/4K video)
- 1:1 (Square format)
- 9:16 (Vertical video)
- 21:9 (Ultra-wide)
...
All aspect ratios are preserved with pixel-perfect accuracy using empirically derived Excel formulas. See [Tests/README.md](Tests/README.md) for details and validation results. 