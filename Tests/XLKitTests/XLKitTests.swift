...
final class XLKitTests: XCTestCase {
    ...
    func testColumnOrderingBeyondZ() {
        ...
        let tempURL = FileManager.default.temporaryDirectory.appendingPathComponent("column_order_test.xlsx")
    ...
    func testColumnOrderingWithGaps() {
        ...
        // Test Excel file generation
        let tempURL = FileManager.default.temporaryDirectory.appendingPathComponent("column_order_gap_test.xlsx")
